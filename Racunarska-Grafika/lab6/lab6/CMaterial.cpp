...
void CMaterial::Select()
{
	glMaterialfv(GL_FRONT, GL_AMBIENT, mvAmbient);
	glMaterialfv(GL_FRONT, GL_DIFFUSE, mvDiffuse);
	glMaterialfv(GL_FRONT, GL_SPECULAR, mvSpecular);
	glMaterialfv(GL_FRONT, GL_EMISSION, mvEmission);
	glMaterialf(GL_FRONT, GL_SHININESS, mfShininess);
}
